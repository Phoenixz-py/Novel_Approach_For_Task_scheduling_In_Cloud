...
#         execution_time = tasks_execution_time[task_id] / vms_processing_speed[vm_id]
...
# print("Task to VM Mapping:")

# for vm_id, task_list in task_to_vm_mapping.items():
#     print(f"VM {vm_id}: Tasks {task_list}")
